...
- Send a valid `Accept-Language` header (alongside `Content-Language`, from the configured language) on eBay REST requests, fixing Sell Inventory API calls that failed with HTTP 400 "Invalid value for header Accept-Language" (errorId 25709).
