...
| [Browse](src/tools/categories/browse.ts) | Price-research comps — sold/completed items (Finding API) and active-listing asking prices (Buy Browse API) |
| [Media](src/tools/categories/media.ts) | Image upload to eBay Picture Services (Media API), returning a hosted image URL for listings |
